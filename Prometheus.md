...
[![NCC Pipeline](https://img.shields.io/badge/NCC→Prometheushttps://github.com/yourorg/nutanix-ncc-or monitoring for Nutanix clusters using NCC Orchestrator → node_exporter textfile collector → Prometheus → Grafana.
​
...
Current clusters: 10.48.52.74(8), 10.48.52.75(8), 10.48.70.178(6), 10.48.108.245(4) ✓
...
Verify: curl localhost:9100/metrics | grep node_textfile_mtime_seconds
​
...
Verify: curl http://localhost:9090/targets → nutanix-ncc UP
...
✅ Prometheus scraping + alerting (:9090)
✅ Grafana dashboard ready (:3000)
✅ 4h cron automation
